<?php
	...
	if (isset($_POST['name']) && (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'],'event_stewarding')) ) {
		...
		// Build INSERT query
		$query = "INSERT INTO tbl_stewarding (name, date_of_birth, email, telephone, address, postcode, datetime_submitted) 
		VALUES('$name', '$date_of_birth', '$email', '$telephone', '$address', '$postcode', '$date_now_mysql')";
		...
		if ($added) {
			...
			<body>';
			$body_html .= '<p>You have received a new \'Event Stewarding Summer Course\' form submission.<br /><br />Submitted: '.$date_now.'</p>';
