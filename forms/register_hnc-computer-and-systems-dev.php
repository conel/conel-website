<?php
	...
	if (isset($_POST['firstname']) && (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'], 'higher_national_certificates_hncs/computer_and_systems_development_qcf_hnc')) ) {
		...
		// Build INSERT query
		$query = "INSERT INTO tbl_hnc_computer_and_systems_development
		...
		if ($added) {
			...
			header('Location: http://www.conel.ac.uk/our_courses/higher_national_certificates_hncs/computer_and_systems_development_qcf_hnc?registration=failed');
			exit;
		}
