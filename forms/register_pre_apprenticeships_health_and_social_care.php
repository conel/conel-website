<?php
	...
	if (isset($_POST['firstname']) && (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'],'our_courses/pre_apprenticeship_in_health_and_social_care')) ) {
		...
		// Build INSERT query
		$query = "INSERT INTO tbl_pre_apprenticeship_health_and_social_care  
		...
		if ($added) {
			...
			header('Location: http://www.conel.ac.uk/our_courses/pre_apprenticeship_in_health_and_social_care?registration=failed');
			exit;
		}
