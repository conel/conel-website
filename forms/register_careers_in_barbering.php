<?php
	...
	if (isset($_POST['firstname']) && (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'],'our_courses/careers_in_hairdressing_and_beauty_therapy/barbering')) ) {
		...
		// Build INSERT query
		$query = "INSERT INTO tbl_careers_in_barbering
		...
		if ($added) {
			...
			*/
			...
			header('Location: http://www.conel.ac.uk/our_courses/careers_in_hairdressing_and_beauty_therapy/barbering?registration=failed');
			exit;
		}
