<?php
	...
	if (isset($_POST['firstname']) && (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'],'our_courses/aat')) ) {
		...
		// Build INSERT query
		$query = "INSERT INTO tbl_accounting_apprenticeship_program  
		...
		if ($added) {
			...
			*/
			...
			header('Location: http://www.conel.ac.uk/our_courses/aat?registration=failed');
			exit;
		}
