<?php
	...
	if (isset($_POST['firstname']) && (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'],'/careers_and_courses_in_construction/construction_enfield')) ) {
		...
		// Build INSERT query
		$query = "INSERT INTO tbl_construction_centre_enfield 
		...
		if ($added) {
			...
			*/
			...
			header('Location: http://www.conel.ac.uk/our_courses/careers_and_courses_in_construction/construction_enfield?registration=failed');
			exit;
		}
