<?php
	...
	if (isset($_POST['firstname']) && (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'],'our_courses/careers_and_courses_in_computing_and_ict')) ) {
		...
		// Build INSERT query
		$query = "INSERT INTO tbl_careers_in_ict 
		...
		if ($added) {
			...
			*/
			...
			header('Location: http://www.conel.ac.uk/our_courses/careers_and_courses_in_computing_and_ict?registration=failed');
			exit;
		}
