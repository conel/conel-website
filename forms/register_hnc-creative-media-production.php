<?php
	...
	if (isset($_POST['firstname']) && (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'], 'higher_national_certificates_hncs/creative_media_production_hnc')) ) {
		...
		// Build INSERT query
		$query = "INSERT INTO tbl_hnc_creative_media_production 
		...
		if ($added) {
			...
			header('Location: http://www.conel.ac.uk/our_courses/higher_national_certificates_hncs/creative_media_production_hnc?registration=failed');
			exit;
		}
