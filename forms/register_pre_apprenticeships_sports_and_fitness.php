<?php
	...
	if (isset($_POST['firstname']) && (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'],'our_courses/pre_apprenticeship_sports_and_fitness')) ) {
		...
		// Build INSERT query
		$query = "INSERT INTO tbl_pre_apprenticeship_sports_and_fitness 
		...
		if ($added) {
			...
			header('Location: http://www.conel.ac.uk/our_courses/pre_apprenticeship_sports_and_fitness?registration=failed');
			exit;
		}
