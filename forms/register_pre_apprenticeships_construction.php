<?php
	...
	if (isset($_POST['firstname']) && (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'],'our_courses/pre_apprenticeships_construction')) ) {
		...
		// Build INSERT query
		$query = "INSERT INTO tbl_pre_apprenticeships_construction 
		...
		if ($added) {
			...
			*/
			...
			header('Location: http://www.conel.ac.uk/our_courses/pre_apprenticeships_construction?registration=failed');
			exit;
		}
