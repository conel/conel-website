<?php
	...
	if (isset($_POST['firstname']) && (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'], 'higher_national_certificates_hncs/engineering_hnc')) ) {
		...
		// Build INSERT query
		$query = "INSERT INTO tbl_hnc_engineering 
		...
		if ($added) {
			...
			header('Location: http://www.conel.ac.uk/our_courses/higher_national_certificates_hncs/engineering_hnc?registration=failed');
			exit;
		}
