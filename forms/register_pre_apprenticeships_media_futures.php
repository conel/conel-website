<?php
	...
	if (isset($_POST['firstname']) && (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'],'our_courses/pre_apprenticeship_in_media_futures')) ) {
		...
		// Build INSERT query
		$query = "INSERT INTO tbl_pre_apprenticeship_media_futures  
		...
		if ($added) {
			...
			header('Location: http://www.conel.ac.uk/our_courses/pre_apprenticeship_in_media_futures?registration=failed');
			exit;
		}
