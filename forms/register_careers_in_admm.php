<?php
	...
	if (isset($_POST['firstname']) && (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'],'careers_and_courses_in_art_music_and_media')) ) {
		...
		// Build INSERT query
		$query = "INSERT INTO tbl_careers_in_art_design_music_media 
		...
		if ($added) {
			...
			*/
			...
			header('Location: http://www.conel.ac.uk/our_courses/careers_and_courses_in_art_music_and_media?registration=failed');
			exit;
		}
