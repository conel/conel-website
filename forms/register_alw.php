<?php
	...
	if (isset($_POST['firstname']) && (isset($_SERVER['HTTP_REFERER']) && strpos($_SERVER['HTTP_REFERER'],'adult_learners_week_14_20_may_2011')) ) {
		...
		// Build INSERT query
		$query = "INSERT INTO tbl_adult_learners_week  
		...
		if ($added) {
			...
			*/
			...
			header('Location: http://www.conel.ac.uk/for_learners/adult_learners_week_14_20_may_2011?registration=failed');
			exit;
		}
