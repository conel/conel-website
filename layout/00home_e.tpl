		...
		<div class="canvas">
			...
			<div id="key_search_bar">
				<div id="key_fact">
                    ...
                    <!--<span id="open_day">College is open as usual on Thursday 24 March</span>-->
					<ul id="fact_scroller">
			...
			<div id="hpcontent">
				<ul id="subnav" class="clearfix tab2">
					<li><a href="/home/home_learners"><span>Information for Learners</span></a></li>
					<li><a href="/home/home_employer" class="active"><span>Information for Employers</span></a></li>
