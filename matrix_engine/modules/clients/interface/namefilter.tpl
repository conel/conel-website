...
<table border="0" width="300" cellspacing="0" cellpadding="0">
	<tr>
		<td align="left" valign="top" colspan="3"><img src="../clients/interface/images/blank.gif" alt="" width="1" height="15" border="0"></td>
	</tr>
	<tr>
		<td align="left" valign="top" class="headline" colspan="3"><b>{language_pagename}</b></td>
	</tr>	
	<tr>
		<td align="left" valign="top" colspan="3"><img src="../clients/interface/images/blank.gif" alt="" width="1" height="5" border="0"></td>
	</tr>	
	<tr>
	...
	<tr>
		<td align="left" valign="top" colspan="3"><img src="../clients/interface/images/dialog_seperator.gif" alt="" width="320" height="2" border="0"></td>
	</tr>
	<tr>
		<td align="left" valign="top" colspan="3"><img src="../clients/interface/images/blank.gif" alt="" width="1" height="5" border="0"></td>
	</tr>	
	...
	<tr>
		...
		<td align="left" valign="top"><img src="../clients/interface/images/blank.gif" alt="" width="10" height="1" border="0"></td>
	...
	<!-- BEGIN footer -->	
	<tr>
		<td align="left" valign="top" colspan="2"><img src="../clients/interface/images/blank.gif" alt="" width="80" height="1" border="0"></td>
		<td align="right" valign="top" rowspan="2">
		{hiddenfields}
		<input width="87" height="24" border=0 type=image name="submit" src="../clients/interface/{saveIMG}"></td>		
	</tr>				
</table>
</td></tr>
</table>
