			...
			<table width="380" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td align="left" colspan="1"><strong>{CurrentEntry}</strong></td>
						</tr>
						<tr>
							<td colspan="1"><img src="../../../../interface/images/blank.gif" width="2" height="1" border="0"></td>
						</tr>
						<tr>
							<td><input type="text" name="newItem" size="28" value="{currentValue}"></td>
						</tr>
						<tr>
							<td colspan="1"><img src="../../../../interface/images/blank.gif" width="2" height="8" border="0"></td>
						</tr>								
					</table>
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							<td><input type="text" name="newValue" size="28" value="{newValue}"></td>
						</tr>
						<tr>
							<td colspan="1"><img src="../../../../interface/images/blank.gif" width="2" height="8" border="0"></td>
						</tr>	
