...
<div id="content">	
<form method="POST" action="{actionURL}" name="m">
<table border="0" width="300" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td align="left" valign="top"class="headline" colspan="4"><b>{language_deletepage}</b></td>
	</tr>	
	<tr>
	...
	<tr>
		...
		<td align="left" valign="top" colspan="3">{language_doyouwant} <b>{menu_text}</b> {language_reallydelete}</td>
	</tr>
	<tr>
		<td align="left" valign="top" colspan="4"><img src="../../interface/images/blank.gif" alt="" width="1" height="5" border="0"></td>
	</tr>
	<tr>
		<td align="left" valign="top" colspan="4"><img src="../../interface/images/dialog_seperator.gif" alt="" width="274" height="2" border="0"></td>
	</tr>
	<tr>
		<td align="left" valign="top"><img src="../../interface/images/blank.gif" alt="" width="25" height="1" border="0"></td>
		<td align="left" valign="top"><img src="../../interface/images/blank.gif" alt="" width="90" height="5" border="0"></td>
		<td align="left" valign="top"><a href="{noURL}"><img src="../../interface/{noIMG}" alt="" width="55" height="24" border="0"></a></td>
		<td align="left" valign="top"><a href="#" onClick="document.m.submit();"><img src="../../interface/{yesIMG}" alt="" width="48" height="24" border="0"></a></td>
	</tr>	
</table>
</td></tr>
</table>{items}
