...
<tr><td valign="top" colspan="16" background="../../interface/images/blank.gif"><img src="../../interface/images/blank.gif" width="10" height="2"></td></tr>	
<!-- END head -->
<!-- BEGIN spacer -->
...
<!-- BEGIN rootelement -->
	...
	<td bgcolor="#DFE1E5" align="left" width="12"><img src="../../interface/images/blank.gif"></td>
	<td bgcolor="#DFE1E5" align="left" width="12"><a href="javascript:wmShowPullDown(0,{id},{level},{menuid},{pageid},1);" mouseOver="parent.status='test';return true;" ><img src="{itemimg}" width="20" height="17" border="0"></a></td>
	<td bgcolor="#DFE1E5" align="left" colspan="7" nowrap><a href="{url}" target="{target}" class="{active}">{text}</a></td></tr>
	<tr><td bgcolor="#DFE1E5" valign="top" colspan="7" background="../../interface/images/menu/menu_seperator.gif"><img src="../../interface/images/menu/menu_seperator.gif" width="10" height="2"></td></tr>
<!-- END rootelement -->
<!-- BEGIN foot -->
</table>
