...
<table border="0" width="300" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td align="left" valign="top" class="headline" colspan="3"><b>{language_selectlayouthead}</b></td>
	</tr>	
	<tr>
	...
	<tr>
		<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="25" height="1" border="0"></td>
		<td align="left" valign="top" colspan="4">{language_selectlayoutbody}</td>
	</tr>
	<tr>
		<td align="left" valign="top" colspan="4"><img src="interface/images/blank.gif" alt="" width="1" height="5" border="0"></td>
	</tr>
	...
	<!-- BEGIN body -->	
	<tr>
		<td align="left" valign="top"><input type="radio" name="templateID" value="{template_id}"></td>
		<td align="left" valign="top"><b>{title}</b></td>
		<td align="left" valign="top" rowspan="2"><img src="interface/images/blank.gif" alt="" width="10" height="1" border="0"></td>
		<td align="left" valign="top" rowspan="2"><img src="{icon}" alt="" border="0"></td>
	</tr>
	<tr>
		<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="25" height="1" border="0"></td>
