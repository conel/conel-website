...
<table border="0" width="300" cellspacing="0" cellpadding="0" >
	...
	<tr>
		<td align="left" valign="top"><b>Einstellungen{language_templateparent}</b></td>
	</tr>	
	<tr>
		<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="1" height="5" border="0"></td>
	</tr>	
	<tr>
		<td align="left" valign="top">
			<table border="0" cellspacing="0" cellpadding="0"><tr>
				...
				<td><p>nicht ausw&auml;hlbar</p></td>
				</tr>
				<tr>
				<td colspan="2"><i>Diese Option ist sinnvoll f&uuml;r Templates von "Boxen".</i></td>
				</tr>				
			</table>
		</td>
	</tr>	
