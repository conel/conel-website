	...
	<tr>
		...
		<table border="0" width="300" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align="left" valign="top" colspan="3" class="headline"><b>Unsubscribes Over Time</b></td>
			</tr>	
	
			<tr>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="25" height="1" border="0"></td>
				<td align="left" valign="top" colspan="4">Track the number of recipients who unsubscribed from this campaign over time.<br></td>
			</tr>
			<tr>
		...
		<table border="0" width="300" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="25" height="1" border="0"></td>
				<td align="left" valign="top"><b>Unsubscribes for each Hour</b><br></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="25" height="1" border="0"></td>
