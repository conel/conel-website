...
<html>
<head>
	<title>Bitte w&auml;hlen Sie ein Layout</title>
...
<table border="0" width="300" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table border="0" width="466" cellspacing="0" cellpadding="0">
			<tr>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="20" height="15" border="0"></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="351" height="15" border="0"></td>
			</tr>
			<tr>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="1" height="1" border="0"></td>
				<td align="left" valign="top" class="headline"><b>Campaign:</b> {newsletter_name}</td>
			</tr>		
		...
		<table border="0" width="300" cellspacing="0" cellpadding="0" >
			<tr>
				<td align="left" valign="top" rowspan="10"><img src="interface/images/blank.gif" alt="" width="25" height="10" border="0"></td>
			...
			<tr>
				<td align="left" valign="top" colspan="3"><img src="../../interface/images/seperator.gif" alt="" width="555" height="2" border="0"></td>
			</tr>
			<tr>
		...
		<table border="0" width="300" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align="left" valign="top" colspan="3" class="headline"><b>Opens Over Time Report</b></td>
			</tr>	
	
			<tr>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="25" height="1" border="0"></td>
				<td align="left" valign="top" colspan="4">The Opens Over Time report highlights the open activity for this campaign.<br><br><b>{newsletter_summary}</b></td>
			</tr>
			<tr>
		...
		<table border="0" width="300" cellspacing="0" cellpadding="0">
			<tr>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="25" height="1" border="0"></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="345" height="1" border="0"></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="10" height="1" border="0"></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="185" height="1" border="0"></td>
			</tr>				
			<tr>
				<td></td>
				<td><img src="{graphURL}" alt="" width="515" height="200" border="0"></td>
			</tr>
		</table>
		...
		<table border="0" width="300" cellspacing="0" cellpadding="0">
			<tr>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="25" height="25" border="0"></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="165" height="1" border="0"></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="25" height="1" border="0"></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="200" height="1" border="0"></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="25" height="1" border="0"></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="140" height="1" border="0"></td>				
			</tr>			
			<tr>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="25" height="1" border="0"></td>
				<td align="left" valign="top"><b>Time Range</b></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="25" height="1" border="0"></td>
				<td align="left" valign="top"><b>Unique Opens for each Hour</b><br></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="25" height="1" border="0"></td>
				<td align="left" valign="top"><b>&nbsp;</b><br></td>				
			</tr>
			<tr>
			...
			<tr>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="25" height="1" border="0"></td>
				<td align="left" valign="top" colspan="5"><img src="interface/images/seperator.gif" alt="" width="555" height="2" border="0"></td>
			</tr>	
			<tr>
				<td align="left" valign="top" colspan="6"><img src="interface/images/blank.gif" alt="" width="1" height="5" border="0"></td>
			</tr>
