...
class phpmailer {
    ...
    */
    ...
    function SendmailSend($header, $body) {
		...
		$sendmail = escapeshellarg($sendmail);
    ...
    function SmtpSend($header, $body) {
        include_once(ENGINE. "classes/class_smtp.php");
        $error = "";
        $bad_rcpt = array();
		...
		// nkowald - 2012-03-05 - Only allow sending from this IP address 194.82.212.17
		/*
		if ($_SERVER['SERVER_ADDR'] != 194.82.212.17) {
			$error = 'Mail sent by unallowed server';
            $this->SetError($error);
			return false;
		}
		*/
