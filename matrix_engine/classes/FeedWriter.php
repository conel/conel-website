 ...
 */
 class FeedWriter
 {
	...
	*/
	...
	{
		$this->setChannelElement('guid', $guid);
	}
	...
	*/
	...
	{        
		...
		else
		{
			...
			// nkowald - modified 2009-08-06
			$nodeText .= (in_array($tagName, $this->CDATAEncoding))? $tagContent : str_replace(array('&','”','“','‘','’','—','–'), array('&','"','"','\'','\'','-','-'), htmlentities($tagContent));
		}           
	...
	private function printChannels()
	{
		...
		switch ($this->version) 
		{
		   case RSS2: 
				...
				echo '<channel>'."\n".'<atom:link href="http://www.conel.ac.uk/rss_news-events.php" rel="self" type="application/rss+xml" />' . PHP_EOL;        
				break;
		   case RSS1: 
