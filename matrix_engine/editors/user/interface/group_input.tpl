...
<table border="0" width="300" cellspacing="0" cellpadding="0" >
	...
	<tr>
		<td align="left" valign="top"><i>{language_userinputnamedesc}</i></td>
	</tr>	
	<tr>
...
<table border="0" width="300" cellspacing="0" cellpadding="0" >
	<tr>
		<td align="left" valign="top" colspan="3"><img src="interface/images/blank.gif" alt="" width="366" height="5" border="0"></td>
	</tr>
	<tr>
		<td align="left" valign="top" colspan="3"><b>{language_pageaccessrights}</b></td>
	</tr>	
	<tr>
		<td align="left" valign="top" colspan="3"><img src="interface/images/blank.gif" alt="" width="1" height="2" border="0"></td>
	</tr>
	...
	<tr>
		<td align="left" valign="top" colspan="3">
			<table border="0"  cellspacing="0" cellpadding="0">
				...
				<tr><td align="left" valign="top"><select name="workspace[]" size="5" multiple style='width:366'>{workspaces}</select></td></tr>
			    <tr><td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="1" height="5" border="0"></td></tr>
			    <tr><td align="left" valign="top"><i>{language_workspace}</i></td></tr>
			</table>
		</td>		
	</tr>
	<tr>
...
<table border="0" width="300" cellspacing="0" cellpadding="0" >
	<tr>
		<td align="left" valign="top" colspan="3"><img src="interface/images/blank.gif" alt="" width="366" height="10" border="0"></td>
	</tr>	
	<tr>
		<td align="left" valign="top" colspan="3"><img src="interface/images/blank.gif" alt="" width="1" height="10" border="0"></td>
	</tr>			
	<tr>
		<td align="left" valign="top">
			<table border="0"  cellspacing="0" cellpadding="0">
				<tr><td align="left" valign="top"><b>{language_templates}</b></td></tr>
				<tr><td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="170" height="5" border="0"></td></tr>	
				<tr>
					<td align="left" valign="top"><p><input type="checkbox" name="templates_add" value="true" {templates_add}>{language_edittemplates}</p></td>
				</tr>
				<tr><td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="1" height="2" border="0"></td></tr>							
			</table>
		</td>
		<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="5" height="1" border="0"></td>
		<td align="left" valign="top">{user_elements}</td>		
	</tr>
	<tr>
		<td align="left" valign="top" colspan="3">			
			<table border="0" cellspacing="0" cellpadding="0">
				<tr><td align="left" valign="top" colspan="6"><b>{language_signoff}</b></td></tr>
				<tr><td align="left" valign="top" colspan="6"><img src="interface/images/blank.gif" alt="" width="170" height="5" border="0"></td></tr>	
				<tr>
				<td align="left" valign="top"><p><input type="radio" name="page_signoff" value="auto_signoff" {auto_signoff}>{language_signoff_auto} <br><i><!--(alle &Auml;nderungen werden automatisch freigegeben)--></i></p></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="14" height="2" border="0"></td>
				<td align="left" valign="top"><p><input type="radio" name="page_signoff" value="signoff" {signoff}>{language_signoff_normal} <br><i><!--(Benutzer k&ouml;nnen Seiten freigeben, eigene &Auml;nderungen m&uuml;ssen explizit freigegeben werden)--></i></p></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="14" height="2" border="0"></td>
				<td align="left" valign="top"><p><input type="radio" name="page_signoff" value="no_signoff" {no_signoff}>{language_signoff_no}<br><i><!--(Benutzer d&uuml;rfen Seiten nicht freigeben)--></i></p></td>
				<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="14" height="2" border="0"></td></tr>							
			</table>			
		</td>		
	</tr>
	<tr>
	...
	<tr>
		<td align="left" valign="top" colspan="3">			
			<table border="0" cellspacing="0" cellpadding="0">
				<tr><td align="left" valign="top" colspan="7"><b>Menu</b></td></tr>
				<tr><td align="left" valign="top" colspan="7"><img src="interface/images/blank.gif" alt="" width="170" height="5" border="0"></td></tr>	
				{menu}
				<tr>
					<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="5" height="5" border="0"></td>
					<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="5" height="2" border="0"></td>
					<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="160" height="5" border="0"></td>
					<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="2" height="5" border="0"></td>
					<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="5" height="5" border="0"></td>
					<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="5" height="2" border="0"></td>
					<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="160" height="5" border="0"></td>
	...
	<tr>
		<td align="left" valign="top" colspan="3">			
			<table border="0" cellspacing="0" cellpadding="0">
				<tr><td align="left" valign="top" colspan="7"><b>Module</b></td></tr>
				<tr><td align="left" valign="top" colspan="7"><img src="interface/images/blank.gif" alt="" width="170" height="5" border="0"></td></tr>	
				{modules}
				<tr>
					<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="5" height="5" border="0"></td>
...
<!-- BEGIN user_element -->
<table border="0"  cellspacing="0" cellpadding="0">
	<tr><td align="left" valign="top"><b>{LANG_GroupUsers}</b></td></tr>
	<tr><td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="170" height="5" border="0"></td></tr>	
	<tr><td align="left" valign="top"><p><input type="radio" name="group" value="edit_all" {allgroup_edit}>{LANG_GroupUsersAllGroups}</p></td></tr>
	<tr><td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="1" height="2" border="0"></td></tr>
	<tr><td align="left" valign="top"><p><input type="radio" name="group" value="edit_own" {owngroup_edit}>{LANG_GroupUsersOwnGroups}</p></td></tr>
	<tr><td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="1" height="2" border="0"></td></tr>
	<tr><td align="left" valign="top"><p><input type="radio" name="group" value="no_edit" {nogroup_edit}>{LANG_GroupUsersNoGroups}</p></td></tr>				
	<tr><td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="1" height="2" border="0"></td></tr>							
</table>
<!-- END user_element -->
