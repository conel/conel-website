...
<table border="0" width="300" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td align="left" valign="top" colspan="3"><p>{message}</p>
</td>
	</tr>
	<tr>
		<td align="left" valign="top" colspan="3"><img src="interface/images/blank.gif" alt="" width="1" height="5" border="0"></td>
	...
	<tr>
		<td align="left" valign="top" colspan="3"><img src="interface/images/dialog_seperator.gif" alt="" width="380" height="2" border="0"></td>
	</tr>
	<tr>
		<td align="left" valign="top" colspan="3"><img src="interface/images/blank.gif" alt="" width="1" height="5" border="0"></td>
	</tr>	
	<tr>
		<td align="left" valign="top" colspan="3"><textarea id="comment" name="comment" rows="10" cols="55">{comment}</textarea></td>
	</tr>
	<tr>
		<td align="left" valign="top" colspan="3"><img src="interface/images/blank.gif" alt="" width="1" height="5" border="0"></td>
	</tr>
