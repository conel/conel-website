...
## data entry...
define("LANG_EnterData","Dateneingabe");
define("LANG_EnterDataDescription","Bitte geben Sie die Daten f&uuml;r diese Seite ein.");
...
define("LANG_PageInfo","Seiteninformationen");
define("LANG_PageInfoDesc","Hier finden Sie Informationen zu der von Ihnen ausgw&auml;hlten Seite.");
define("LANG_PageInfo_Created","Erstellt");
define("LANG_PageInfo_Modified","Ge&auml;ndert");
define("LANG_PageInfo_PageId","Referenz Nr.");
define("LANG_PageInfo_URL","URL");
define("LANG_PageInfo_Template", "Vorlage");
...
define("LANG_MenuMove","Verschieben");
define("LANG_MenuInfo","Informationen");
define("LANG_MenuTimer","Automatisierung");
...
## the tabs
define("LANG_TAB_PAGE", "Seiten");
define("LANG_TAB_TEMPLATES", "Vorlagen");
define("LANG_TAB_USER", "Nutzer");
...
define("LANG_VERSION_PageLocked", "Seite gesperrt");
define("LANG_VERSION_PageLocked_Desc", "Die Seite wird zur Zeit von einem anderen Benutzer bearbeitet.");
...
define("LANG_ROOTPAGE", "Hauptebene");
define("LANG_MovePage", "Seite verschieben");
define("LANG_MovePageDesc", "Bitte w&auml;hlen Sie die Seite unter die Sie die gew&auml;hlte Seite verschieben wollen.");

define("LANG_MovePageSuccess", "Seite erfolgreich verschoben");
define("LANG_MovePageSuccessDesc", "Die von Ihnen gew&auml;hlte Seite wurde erfolgreich verschoben");

## version added for 2.0
define("LANG_VERSION_VersionExistsTitle", "Einige Daten auf dieser Seite wurden ver&auml;ndert.");
define("LANG_VERSION_VersionExistsDesc", "Sollen die noch nicht freigegeben &Auml;nderungen an dieser Seite freigegeben werden?");

## added version 3.0
define("LANG_MENU_COPYPAGE", "Seite kopieren");
define("LANG_CopyPageDesc", "Wollen Sie diese Seite wirklich kopieren?");
define("LANG_CopyPageSuccess", "Die Seite wurde erfolgreich kopiert.");

## added version 3.0.1
define("LANG_MENU_COPYSTRUCTURE", "Struktur kopieren");
define("LANG_CopyStructureDesc", "Wollen Sie alle Seiten unterhalb dieser Seite kopieren?");
define("LANG_CopyStructureSuccess", "Die Seiten wurden erfolgreich kopiert.");
?>