...
<table border="0" width="400" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td align="left" valign="top" class="headline" colspan="3"><b>Redirect Page</b></td>
	</tr>	
	<tr>
		<td align="left" valign="top" colspan="3"><img src="interface/images/blank.gif" alt="" width="1" height="5" border="0"></td>
	</tr>	
	<tr>
		<td align="left" valign="top" colspan="3">Please enter a Redirection URL for this page.<br /><br />
		To delete an existing redirect clear URL text from the 'Redirection URL' field then press Save.</td>
	</tr>
	<tr>
		<td align="left" valign="top" colspan="3"><img src="interface/images/blank.gif" alt="" width="1" height="5" border="0"></td>
	</tr>
...
<table border="0" width="400" cellspacing="0" cellpadding="0" >
	...
	<tr>
		<td align="left" valign="top" colspan="3"><p>{value}</p></td>
	</tr>
	<tr>
		<td align="left" valign="top"><img src="interface/images/blank.gif" alt="" width="80" height="1" border="0"></td>
		<td align="right" valign="top"><input border=0 type=image name="submit" src="interface/{saveIMG}"></td>		
	</tr>	
	<tr>
