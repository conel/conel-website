...
<tr>
	...
	<td valign="top" align="left" width="12"><a href="javascript:submitSelectedPage('0')"><img src="interface/images/menu/free_folder.gif" width="20" height="17" border="0"></a></td>
	<td valign="top" align="left" colspan="12" nowrap><a href="javascript:submitSelectedPage('0')" target="text" class="active">{LANG_ROOTPAGE}</a></td></tr>
<tr><td valign="top" colspan="13" background="interface/images/menu/menu_seperator.gif"><img src="interface/images/menu/menu_seperator.gif" width="10" height="2"></td></tr><tr>	
<!-- END head -->
<!-- BEGIN spacer -->
