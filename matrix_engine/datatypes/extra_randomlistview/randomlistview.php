...
## =======================================================================        
## randomlistview_displayInput        
## =======================================================================        
## displays the input form
## ======================================================================= 
function randomlistview_displayInput($xmldata, $data) {
	return "";
}


## =======================================================================        
## randomlistview_storeData        
## =======================================================================        
## save the content in the db
## ======================================================================= 
function randomlistview_storeData($page_id, $identifier) {
	return false;
}

## =======================================================================        
## randomlistview_getData        
## =======================================================================        
##  get the Data
## ======================================================================= 
function randomlistview_getData($vPageID,&$page_record) {
}

## =======================================================================        
## randomlistview_getMultiData       
## =======================================================================        
##  get the Data for multiple pages
## ======================================================================= 
function randomlistview_getMultiData($vItems) {
}

## =======================================================================        
## randomlistview_deleteData        
## =======================================================================        
##  deletes all text entries of a page
## ======================================================================= 
function randomlistview_deleteData($vPageID) {
}

## =======================================================================        
##  output_randomlistview        
## =======================================================================        
##  call this function to output an text 
## ======================================================================= 
function randomlistview_output($item,$structure,&$layout_template,$menu_id,$page_id) {
	global $Auth;
	...
	if(isset($structure['FIELD'])) {
		...
		internalRandomListview_getByCategory($page_id,$db_connectionMain,$structure);
	}
...
## =======================================================================        
##  internalRandomListview_getByCategory    
## =======================================================================        
...
##     - test if it works
## ======================================================================= 
function internalRandomListview_getByField($page_id,&$db,$field) {
	global $Auth;
	...
	$select_query = "SELECT DISTINCT page_id FROM ".PAGE_CONTENT." AS A WHERE ".$query." AND A.client_id ='".$client_id."' ORDER BY RAND()";
...
##     - test if it works
## ======================================================================= 
function internalRandomListview_getByCategory($page_id,&$db,$xmldata) {
	global $Auth;
	...
	$secondpart = "WHERE (".$template_query.") AND (structure_flag >= 2) AND ".USER_PAGES.".client_id=$client_id ORDER BY RAND()";
	...
	if($scope == "GLOBAL") {		
		...
		if($query !="") {
			$select_query = "SELECT ".STRUCTURE.".page_id, structure_text, ".USER_PAGES.".template FROM ".STRUCTURE." INNER JOIN ".USER_PAGES." ON ".STRUCTURE.".page_id = ".USER_PAGES.".page_id WHERE (".$template_query.") AND (".$query.") AND (structure_flag >= 2) AND ".USER_PAGES.".client_id=$client_id  ORDER BY RAND() ";
			$result_pointer = $db->query($select_query);
		}
		...
		$select_query = "SELECT ".STRUCTURE.".page_id, structure_text, ".USER_PAGES.".template FROM ".STRUCTURE." INNER JOIN ".USER_PAGES." ON ".STRUCTURE.".page_id = ".USER_PAGES.".page_id WHERE (".$template_query.") AND structure_parent=".$structure_id." AND (structure_flag >= 2) AND ".USER_PAGES.".client_id=$client_id ORDER BY RAND() ";
