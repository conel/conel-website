...
switch($op) {            
	case "add":
		...
		alias_displayInputForm($linkItemID,$linklistID,$page_id,$identifier);
		break;
	...
	case "delete":
		...
		alias_promptDelete($yesURL,$noURL);		
		break;
	...
	case "doDelete":
		...
		alias_deletItem($pageID, $identifier, $itemID);
		alias_close_reload("");
		break;
...
##  TODO:
## =======================================================================        
function alias_close_reload($targetURL) {
	global $gSession;
