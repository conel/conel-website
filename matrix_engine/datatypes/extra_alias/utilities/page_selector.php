...
function page_selector_drawMenu($vTree,$vVarsToBeSet,$vTargetURL) {
	...
	$layout_template = new Template(ENGINE."datatypes/extra_alias/interface");
	...
	$layout_template->set_var("Title",LANG_ALIAS_SelectTitle);
	$layout_template->set_var("Desc",LANG_ALIAS_SelectDesc);
