...
## =======================================================================        
## rowview_displayInput        
## =======================================================================        
## displays the input form
## ======================================================================= 
function rowview_displayInput($xmldata, $data) {
	return "";
}
...
## ======================================================================= 
function rowview_storeData($page_id, $identifier) {
	return false;
}
...
##  get the Data
## ======================================================================= 
function rowview_getData($vPageID,&$page_record) {
}

## =======================================================================        
##  rowview_getMultiData       
## =======================================================================        
##  get the Data for multiple pages
## ======================================================================= 
function rowview_getMultiData($vItems) {
}
...
## ======================================================================= 
function rowview_deleteData($vPageID) {
}
...
## ======================================================================= 
function rowview_output($item,$structure,&$layout_template,$menu_id,$page_id) {
	global $Auth;
	...
	if(isset($structure['TEMPLATE'])) {
		...
		$container_template->set_templatefile(array("pager" => $filename,"head" => $filename,"emptybody" => $filename,"rowstart" => $filename,"rowend_alternate" => $filename,"rowstart_alternate" => $filename,"rowend" => $filename,"body" => $filename,"foot" => $filename,"empty" => $filename,"active" => $filename,"alternate" => $filename)); 
	}
	...
	while($db_connectionMain->next_record() && ($item_counter <= $items)) {
		...
		if(!isset($structure['TEMPLATE'])) {
			...
			$container_template = new Template(HTML_DIR);
			$container_template->set_templatefile(array("pager" => $filename,"head" => $filename,"rowstart" => $filename,"rowend" => $filename,"emptybody" => $filename,"body" => $filename,"foot" => $filename,"empty" => $filename,"alternate" => $filename)); 
		}			
		...
		if($container_template->block_items['alternate']) {
			...
			if (isset($structure['HIGHLIGHT']) && $structure['HIGHLIGHT'] && $container_template->block_items['active']) {
				if ($page_id != $current_page) {
					$storage .= $container_template->fill_block("body");
				} else {
					$storage .= $container_template->fill_block("active");
	...
	if(isset($structure['COUNT']) && ($structure['HIDEPAGEELEMENT'] == false || !isset($structure['HIDEPAGEELEMENT']))) {
		$page_navigation = internalrowview_dspPageElement($page_id,$db_connectionMain,$totalItems,$items,$_GET["offset"], $structure['DELTA'],$structure['NAME']);
...
## =======================================================================        
##  internalrowview_dspPageElement   
## =======================================================================        
...
## ======================================================================= 
function internalrowview_dspPageElement($page_id,&$db,$totalItems, $itemsPerPage,$offset, $delta,$identifier) {
