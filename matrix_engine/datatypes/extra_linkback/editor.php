...
switch($op) {            
	case "add":
		...
		linkback_displayInputForm($linkItemID,$linklistID,$page_id,$identifier);
		break;
	...
	case "delete":
		...
		linkback_promptDelete($yesURL,$noURL);		
		break;
	...
	case "doDelete":
		...
		linkback_deletItem($page_id, $identifier, $itemID);
		linkback_close_reload("");
		break;
					
	case "sort":
		## this is the beginning
		linkback_sort_displayInputForm();
		break;

	case "doSort":
		## do the actual sorting
		linkback_sort_setItemOrder($_POST['linklistID'],$_POST['linkID'],$_POST['order'], $_POST['move']);
...
##  TODO:
## =======================================================================        
function linkback_close_reload($targetURL) {
	global $gSession;
