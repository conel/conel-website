...
## ======================================================================= 
function bigmovie_displayInput($xmldata, $data) {
	global $gSession,$g_pageID,$input_language;
	## init the vars
	$return = "";

	## we should open our own template
	$template = new Template(ENGINE."datatypes/extra_bigmovie/interface/");
	...
	$addlinkURL = SITE."datatypes/extra_bigmovie/editor.php?op=add&page_id=".$g_pageID."&identifier=".$xmldata['NAME']."&language=".$input_language;
	$addlinkURL = $gSession->url($addlinkURL);	
		
	$deletelinkURL = SITE."datatypes/extra_bigmovie/editor.php?op=delete&page_id=".$g_pageID."&language=".$input_language."&identifier=".$xmldata['NAME'];		
	...
	$template->set_var('PATH',SITE."datatypes/extra_bigmovie/interface/");
...
## ======================================================================= 
function bigmovie_storeData($page_id, $identifier) {
}
...
##  get the Data
## ======================================================================= 
function bigmovie_getData($vPageID,&$page_record) {
	...
	$select_query = "SELECT movie_id,filename,width,height,autoplay, identifier FROM ".DB_PREFIX."page_movie WHERE page_id='$vPageID' AND client_id='$client_id'";
	...
	while($db_connectionMain->next_record()) {
		...
		$page_record[$varname]["autoplay"] = $autoplay; 
...
## ======================================================================= 
function bigmovie_deleteData($vPageID) {
	global $Auth;
...
## ======================================================================= 
function bigmovie_output($item,$structure,$menu_id) {
...
##  call this function to output an text 
## ======================================================================= 
function bigmovie_displayPreview($xmldata, $data) {
...
## ======================================================================= 
function bigmovie_copyData($source_id, $target_id) {
	global $Auth;
	## multiclient
	$client_id = $Auth->auth['client_id'];	
