...
## ======================================================================= 
function zoomimage_displayInput($xmldata, $data) {
...
## ======================================================================= 
function zoomimage_storeData($page_id, $identifier) {
...
##  get the Data
## ======================================================================= 
function zoomimage_getData($vPageID,&$page_record) {
...
## ======================================================================= 
function zoomimage_deleteData($vPageID) {
...
## ======================================================================= 
function zoomimage_output($item,$structure,$menu_id) {
	if(!$item) {
		return "";
	}
	...
	if(!file_exists(MATRIX_UPLOADDIR.$fileInfo[0].'_'.$width.'_'.$height.'.'.$fileInfo[1])) {
		...
		## place our zoom icon on top of that image
		$zoomIcon = ImageCreateFromPNG(ENGINE."datatypes/extra_zoomimage/resources/zoom_icon.png");
		$targetImage = imagecreatetruecolor($width,$height);
		imagecopy($targetImage, $mainImage, 0, 0, 0, 0, $width,$height);
		//imagecopymerge($targetImage, $zoomIcon, ($width-18), ($height-18), 0, 0, 18, 18, 100);
		
		## save the image
		Imagejpeg($targetImage,MATRIX_UPLOADDIR.$fileInfo[0].'_'.$width.'_'.$height.'.jpg',90);
		ImageDestroy($targetImage);
	}

	## setup the return value
	$image = '<a href="/'.UPLOAD_DIR.$filename.'" rel="zoom" title="'.$alt.'" target="_blank"><img src="/'.UPLOAD_DIR.$fileInfo[0].'_'.$width.'_'.$height.'.jpg" alt="'.$alt.'" width="'.$width.'" height="'.$height.'" border="0" /></a>';
...
##  deletes all text entries of a page
## ======================================================================= 
function zoomimage_copyData($source_id, $target_id) {
