...
<table width="200" border="0" cellspacing="0" cellpadding="0">	
	...
	<tr>
		...
		<td valign="top" width="22"><a href="javascript:linklist_editLink('{sortURL}','linklist')"><img src="interface/images/icon_sort.gif" width="26" height="24" border="0"></a></td>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">	
	...
	<tr>
		<td valign="middle"><b>{element_tag}</b></td>
		<td valign="top" colspan="2"><img src="interface/images/blank.gif" width="22" height="18"></td>
		<td valign="top" width="22"><a href="javascript:linklist_editLink('{addlinkItemURL}')"><img src="interface/images/icon_edit.gif" width="26" height="24" border="0"></a></td>
		<td valign="top" width="22"><a href="javascript:linklist_editLink('{sortURL}')"><img src="interface/images/icon_sort.gif" width="26" height="24" border="0"></a></td>
		<td valign="top" width="22"><a href="javascript:linklist_deleteLink('{deletelinkItemURL}')"><img src="interface/images/icon_trash.gif" width="26" height="24" border="0"></a></td>
	</tr>	
	<tr>
		<td valign="top"><img src="interface/images/blank.gif" width="208" height="1"></td>
