...
<table width="300" border="0" cellspacing="0" cellpadding="0">	
	...
	<tr>
		...
		<td valign="top" width="22"><a href="javascript:linklist_editLink('{deletelinkItemURL}')"><img src="interface/images/icon_trash.gif" width="26" height="24" border="0"></a></td>
	</tr>	
	<tr>
	...
	<tr>
		...
		<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="320" height="100" id="video_player" align="middle">
			<param name="allowScriptAccess" value="sameDomain" />
			<param name="movie" value="datatypes/extra_movie/resources/video_player.swf?flv={filename}" />
			<param name="quality" value="high" />
			<param name="bgcolor" value="#ffffff" />
			<embed src="datatypes/extra_movie/resources/video_player.swf?flv={filename}" quality="high" bgcolor="#ffffff" width="320" height="100" name="video_player" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
		</object>
