...
<table width="300" border="0" cellspacing="0" cellpadding="0">	
	...
	<tr>
		...
		<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" width="366" height="50" id="audio_player" align="middle">
			<param name="allowScriptAccess" value="sameDomain" />
			<param name="movie" value="datatypes/extra_audio/interface/resources/audio_player.swf?track={TRACK}&duration={DURATION}" />
			<param name="quality" value="high" />
			<param name="bgcolor" value="#ffffff" />
			<embed src="datatypes/extra_audio/interface/resources/audio_player.swf?track={TRACK}&duration={DURATION}" quality="high" bgcolor="#ffffff" width="366" height="50" name="audio_player" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
		</object>
