<?php
	...
	if ($_SESSION['course_guide'] === TRUE) {
		...
		$cg_content = '<p>Thank you for submitting the form.<br />Your selected course guide(s) are available below:</p>';
		...
		if ($_SESSION['selected_guides'] && is_array($_SESSION['selected_guides'])) {
			...
			foreach ($_SESSION['selected_guides'] as $guide) {
				...
				if ($guide == "ACG EC") {
					$cg_content .= '<li><a href="http://www.conel.ac.uk/docs/MCG_Enfield_2011_12.pdf"><span><img src="/layout/img/pdf.gif" alt="PDF file" /> Enfield Adult Course Guide 2011-12, 9.78 MB</span></a></li>';
				}
				if ($guide == "YPCG TC") {
				...
				if ($guide == "ACG TC") {
					$cg_content .= '<li><a href="http://www.conel.ac.uk/docs/MCG_Tottenham_2011_12.pdf"><span><img src="/layout/img/pdf.gif" alt="PDF file" /> Tottenham Adult Course Guide 2011-12, 7.17 MB</span></a></li>';
				}
			}
			$cg_content .= '</ul>';
		}
	...
	function module_getBanners() {
		...
		<div class="wt-rotator">
			<img id="bg-img" src="/layout/img/spacer.png" alt="" />
			<a href="#"><img id="main-img" src="'.$banners[0]['img_url'].'" alt="" /></a>
			<div class="desc"></div>
			<div class="preloader"><img src="/layout/img/loader.gif" alt="" /></div>
			<div id="tooltip"></div>
			<div class="c-panel">
				<div class="buttons">   
		...
		if (count($banners) == 0) {
			$output .= '<li><a href="/layout/img/hero2.jpg"></a><a href="#"></a></li>';
		} else {
			foreach ($banners as $banner) {
				$output .= "<li><a href=\"".$banner['img_url']."\"></a><a href=\"".$banner['link']."\"></a></li>\n";
			}
		}
...
function _page_generatePage($page_id,$template) {
	...
	*/
	...
	function module_getRandomQuotePic() {
		...
		/* Old Profiles
		$profile_alts = array(
			1 => array('name' => 'Aleksandra (Business and Accounting)', 'quote' => 'Executive assistance - Aleksandra, Business Administration NVQ Level 1', 'url' => '/for_learners/success_stories/aleksandra'),
			2 => array('name' => 'Bianca (Sport BTEC)', 'quote' => 'Mind and Body - Bianca, Sport BTEC', 'url' => '/for_learners/success_stories/bianca'),
			3 => array('name' => 'Bouchra (Science BTEC)', 'quote' => 'Experiment and analyse - Bouchra, Science BTEC', 'url' => '/for_learners/success_stories/bouchra'),
			4 => array('name' => 'Dragos (Travel and Tourism)', 'quote' => 'Going places - Dragos, Travel and Tourism and Airport Studies', 'url' => '/for_learners/success_stories/dragos'),
			5 => array('name' => 'Kat (Hair and Beauty)', 'quote' => 'Looking good - Kat, Nail Services NVQ', 'url' => '/for_learners/success_stories/kat'),
			6 => array('name' => 'Kumars (ESOL)', 'quote' => 'Common language - Kumars, ESOL Entry Level 3', 'url' => '/for_learners/success_stories/kumars'),
			7 => array('name' => 'Lee (Construction and Built)', 'quote' => 'Building for success - Lee, Painting and Decorating Diploma', 'url' => '/for_learners/success_stories/lee'),
			8 => array('name' => 'Maggie (Art Design and Media)', 'quote' => 'Creativity reigns - Maggie, Art and Design BTEC', 'url' => '/for_learners/success_stories/maggie'),
			9 => array('name' => 'Marcia (English and Maths)', 'quote' => 'Developing skills - Marcia, English Entry Level 3', 'url' => '/for_learners/success_stories/marcia'),
			10 => array('name' => 'Maureen (Teacher Education)', 'quote' => 'Knowledge sharing - Maureen, Diploma to Teach in the Lifelong Learning Sector', 'url' => '/for_learners/success_stories/maureen'),
			11 => array('name' => 'Natalie (Healthcare and EY)', 'quote' => 'Helping others - Natalie, Access to Nursing', 'url' => '/for_learners/success_stories/natalie'),
			12 => array('name' => 'Omid (ICT Computing)', 'quote' => 'Finding the right code - Omid, ICT Level 3', 'url' => '/for_learners/success_stories/omid'),
			13 => array('name' => 'Ahmed (Business and Accounting)', 'quote' => 'Investing in your future - Ahmed, Accounting AAT Level 3', 'url' => '/for_learners/success_stories/ahmed'),
			14 => array('name' => 'Azize (ESOL Tutor)', 'quote' => 'Hola, Bonjour, Merhaba, Czesc - Azize, Tutor', 'url' => '/for_learners/success_stories/azize'),
			15 => array('name' => 'Catherine (Construction)', 'quote' => 'Olympic legacy - Catherine, Plubming Apprenticeship', 'url' => '/for_learners/success_stories/catherine'),
			16 => array('name' => 'Jahkeeta (Arts and Media)', 'quote' => 'Fun and games - Jahkeeta, Games Development BTEC National Certificate', 'url' => '/for_learners/success_stories/jahkeeta'),
			17 => array('name' => 'Sonia (Science)', 'quote' => 'Life under the microscope - Sonia, Access to Biological Science', 'url' => '/for_learners/success_stories/sonia'),
			18 => array('name' => 'Tracey (Hair and Beauty)', 'quote' => 'Persuing your dream - Tracy, Beauty Therapy NVQ Level 2', 'url' => '/for_learners/success_stories/tracey'),
			19 => array('name' => 'Louise (Care and Health)', 'quote' => 'It\'s all in the mind - Louise, Access to Pyschology', 'url' => '/for_learners/success_stories/louise'),
			20 => array('name' => 'Susan (Teacher Training)', 'quote' => 'A cut above the rest - Susan, Diploma to Teach in the Lifelong Learning Sector', 'url' => '/for_learners/success_stories/susan')	
		);
		*/
		$profile_alts = array(
			...
			4 => array('name' => 'Becky Lloyd', 'quote' => 'Beauty Therapy Level 3 - Becky', 'url' => '/for_learners/success_stories/becky_lloyd'),
			5 => array('name' => 'Carol Craig', 'quote' => 'Access to Higher Education Diplomoa - Carol', 'url' => '/for_learners/success_stories/carol_craig'),
			6 => array('name' => 'Cass-Shawn Kedroe', 'quote' => 'Public Services BTEC Level 2 - Cass-Shawn', 'url' => '/for_learners/success_stories/cass_shawn_kedroe'),
			7 => array('name' => 'Daisy Cabascango', 'quote' => 'Basic Construction Certificate - Daisy', 'url' => '/for_learners/success_stories/daisy_cabascango'),
			8 => array('name' => 'Daniel Zurawski', 'quote' => 'IT BTEC Diploma Level 3 - Daniel', 'url' => '/for_learners/success_stories/daniel_zurawski'),
			9 => array('name' => 'Daniela Cerri', 'quote' => 'Hairdressing Level 3 - Daniela', 'url' => '/for_learners/success_stories/daniela_cerri'),
			10 => array('name' => 'David Wood', 'quote' => 'Plumbing Apprenticeship Level 3 - David', 'url' => '/for_learners/success_stories/david_wood'),
			11 => array('name' => 'Donna Kavanagh', 'quote' => 'Diploma to teach in the Lifelong Sector (DTTLS) - Donna', 'url' => '/for_learners/success_stories/donna_kavanagh'),
			12 => array('name' => 'Fatma Ispir', 'quote' => 'Health and Social Care BTEC Level 2 - Fatma', 'url' => '/for_learners/success_stories/fatma_ispir'),
			13 => array('name' => 'Feysal Mohamed', 'quote' => 'Skills for Work and Life Entry 3 (Literacy and Numeracy) - Feysal', 'url' => '/for_learners/success_stories/feysal_mohamed'),
			14 => array('name' => 'Gokhan Bektas', 'quote' => 'ESOL Entry 2 - Gokhan', 'url' => '/for_learners/success_stories/gokhan_bektas'),
			15 => array('name' => 'Justina Subaciute', 'quote' => 'ESOL Skills for Study and Work Level 1 - Justina', 'url' => '/for_learners/success_stories/justina_subaciute'),
			16 => array('name' => 'Kyron Williams', 'quote' => 'Sports Development and Fitness BTEC Level 3 - Kyron', 'url' => '/for_learners/success_stories/kyron_williams'),
			17 => array('name' => 'Lakia Bryan', 'quote' => 'Art and Design (Fashion) BTEC Level 3 - Lakia', 'url' => '/for_learners/success_stories/lakia_bryan'),
			18 => array('name' => 'Lauren Kyriacou', 'quote' => 'Business BTEC Level 3 - Lauren', 'url' => '/for_learners/success_stories/lauren_kyriacou'),
			19 => array('name' => 'Lewis Warner', 'quote' => 'Sports Development and Fitness BTEC Level 3 - Lewis', 'url' => '/for_learners/success_stories/lewis_warner'),
			20 => array('name' => 'Marlon Amaechi', 'quote' => 'Nursing - Access to Higher Education Diploma - Marlon', 'url' => '/for_learners/success_stories/marlon_amaechi'),
			21 => array('name' => 'Mina Abdurahman', 'quote' => 'Art and Design BTEC Diploma Level 3 - Mina', 'url' => '/for_learners/success_stories/mina_abdurahman'),
			22 => array('name' => 'Nura Mubarak', 'quote' => 'IT and Business BTEC Level 3 - Nura', 'url' => '/for_learners/success_stories/nura_mubarak'),
			23 => array('name' => 'Olga Obineche', 'quote' => 'Spanish Entry 3 - Olga', 'url' => '/for_learners/success_stories/olga_obineche'),
			24 => array('name' => 'Roman Barenga', 'quote' => 'Science BTEC Level 2 - Roman', 'url' => '/for_learners/success_stories/roman_barenga'),
			25 => array('name' => 'Sonny Kane', 'quote' => 'Access to Engineering - Sonny', 'url' => '/for_learners/success_stories/sonny_kane'),
			26 => array('name' => 'Stacy Byfield', 'quote' => 'English Level 1 - Stacy', 'url' => '/for_learners/success_stories/stacy_byfield'),
			27 => array('name' => 'Stephen Mafolabomi', 'quote' => 'Business BTEC Level 3 - Stephen', 'url' => '/for_learners/success_stories/stephen_mafolabomi')
		);
		...
		$rand_quote = '<a href="http://www.conel.ac.uk/our_courses/enrolment_2011/"><img src="/layout/img/banner-enrolment.gif" alt="Enrolment starts Monday 22 August" width="363" height="136" /></a>';
		...
		if ($important_msg == '') {
			...
			<h3 class="hidden">Fast Facts</h3>
                <ul id="fact_scroller">
                    ...
                    <li>Multi-faith chaplaincy offers support to everyone</li>
                    ...
                    <li>Employer training recognised and awarded by TQS</li>
                </ul>';
		} else {
